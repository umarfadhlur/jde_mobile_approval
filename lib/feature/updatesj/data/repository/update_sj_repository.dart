...
abstract class UpdateSJRepository {
  ...
  Future<bool?> updateSJ(
      String nomorSJ, String shipmentNumber, String vehicleNo, String supir);
}

class UpdateSJRepositoryImpl implements UpdateSJRepository {
  @override
  ...
  @override
  Future<bool?> updateSJ(String nomorSJ, String shipmentNumber,
      String vehicleNo, String supir) async {
    Map<String, dynamic> requestData = {
      "username": "jde",
      "password": "jde",
