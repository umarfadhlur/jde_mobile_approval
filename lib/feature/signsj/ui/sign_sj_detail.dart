...
import '../cubit/sign_sj_cubit.dart';
import '../cubit/sign_sj_state.dart';

class SignSJPageDetail extends StatelessWidget {
  final String vehicleNumber;

  const SignSJPageDetail({Key? key, required this.vehicleNumber})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: SignSJViewDetail(vehicleNumber: vehicleNumber),
    );
  }
}

class SignSJViewDetail extends StatefulWidget {
  final String vehicleNumber;

  const SignSJViewDetail({super.key, required this.vehicleNumber});

  @override
  State<SignSJViewDetail> createState() => _SignSJViewDetailState();
}

class _SignSJViewDetailState extends State<SignSJViewDetail> {
  ...
  void initState() {
    ...
    super.initState();
    context.read<SignSJCubit>().fetchShipmentDetails(widget.vehicleNumber);
  }
  ...
  Widget _buildSearchResults() {
    return BlocBuilder<SignSJCubit, SignSJState>(
      builder: (context, state) {
        ...
        } else if (state is SignSJDetailSuccess) {
